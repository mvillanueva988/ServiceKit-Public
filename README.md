...
```powershell
$f = "$env:TEMP\PCTk-Launch.ps1"; irm https://raw.githubusercontent.com/mvillanueva988/ServiceKit-Public/v2.8.0/Launch.ps1 -OutFile $f; powershell -NoProfile -ExecutionPolicy Bypass -File $f
```

Reemplaza `v2.8.0` por el tag de la última release estable. Instala en `C:\PCTk\` y lanza el toolkit. Cada ejecución descarga la versión más reciente y valida su integridad (SHA-256) antes de instalar.
...
Invoke-WebRequest -Uri 'https://raw.githubusercontent.com/mvillanueva988/ServiceKit-Public/v2.8.0/Launch.ps1' -OutFile $f
